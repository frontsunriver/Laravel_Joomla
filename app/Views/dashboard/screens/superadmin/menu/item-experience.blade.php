@if(is_enable_service('experience'))
    <div class="hh-add-menu-box overflow-hidden">
        <h5 class="title d-flex align-items-center justify-content-between">{{__('Experience')}} <i
        ...
        <div class="menu-content-wrapper">
            <div class="content">
                ...
                <div class="checkbox  checkbox-success mb-2">
                    ...
                    <label
                        for="menu_item_experience_{{ $item->post_id  }}">{{ get_translate($item->post_title) }}</label>
                </div>
                <?php
                }
                }else {
