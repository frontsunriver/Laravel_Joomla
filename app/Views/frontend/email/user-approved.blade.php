...
<div class="hh-email-wrapper">
    ...
    <div class="content-email">
        <h2 style="color:#0079c1; margin-bottom: 20px;">{{sprintf(__('Hi, %s!'), get_username($user->getUserId()))}}</h2>
        <br/>
        <?php
        ...
        <p>{{__('Your user registration request has been approved. You can login and user our service now.')}}</p>
        <?php }
        ?>
        <br/>
